  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0">
        <Image src="/images/hero-cake.jpg" alt="Delicioso pastel decorado" fill className="object-cover" priority />
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        >
          Tartas y postres personalizados para tus eventos especiales, elaborados con los mejores ingredientes y mucho
          amor
        </motion.p>
